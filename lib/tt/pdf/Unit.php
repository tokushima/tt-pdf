...
class Unit{
	...
	private const PAPERS = [
		...
		// 印刷用原紙（裁ち判）
		'KIKU_HAN'     => [469, 636, '菊半裁'],
		'KIKU_4'       => [318, 469, '菊4裁'],
		'KIKU_8'       => [234, 318, '菊8裁'],
		'SHIROKU_HAN'  => [545, 788, '四六半裁'],
		'SHIROKU_4'    => [394, 545, '四六4裁'],
		'SHIROKU_8'    => [272, 394, '四六8裁'],
		...
		// 名刺・カード
		'BUSINESS_CARD'    => [91, 55, '名刺 (日本サイズ)'],
		'BUSINESS_CARD_US' => [88.9, 50.8, '名刺 (米国サイズ)'],
		'BUSINESS_CARD_EU' => [85, 55, '名刺 (欧州サイズ)'],
		'CREDIT_CARD'      => [85.6, 53.98, 'クレジットカード'],
		...
		'PHOTO_SQUARE'    => [89, 89, 'ましかくプリント'],
		'PHOTO_SQUARE_2L' => [127, 127, '2Lましかくプリント'],
		'SQUARE_100'      => [100, 100, 'スクエア 100mm'],
		'SQUARE_148'      => [148, 148, 'スクエア 148mm (A6スクエア)'],
		'SQUARE_210'      => [210, 210, 'スクエア 210mm (A4スクエア)'],
